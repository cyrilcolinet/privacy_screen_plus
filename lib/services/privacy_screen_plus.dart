...
import 'package:privacy_screen_plus/states/privacy_screen_plus_state.dart';

class PrivacyScreenPlus {
  PrivacyScreenPlus._();

  static final PrivacyScreenPlus _instance = PrivacyScreenPlus._init();

  static PrivacyScreenPlus _init() {
    _channel.setMethodCallHandler(_callHandler);
    return PrivacyScreenPlus._();
  }
  ...
  static PrivacyScreenPlus get instance => _instance;
  ...
  final ValueNotifier<PrivacyScreenPlusState> stateNotifier =
      ValueNotifier(const PrivacyScreenPlusState());
  ...
  Future<bool> disable() async {
    final targetValue = stateNotifier.value.copyWith(
  ...
  Future<bool> _updateNative({
    ...
    final result = await PrivacyScreenPlusPlatform.instance.updateConfig(
      iosOptions: iosOptions,
      androidOptions: androidOptions,
      backgroundColor: backgroundColor,
      blurEffect: blurEffect,
