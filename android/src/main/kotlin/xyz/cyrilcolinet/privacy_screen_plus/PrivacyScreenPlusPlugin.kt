package xyz.cyrilcolinet.privacy_screen_plus
...
/** PrivacyScreenPlusPlugin */
class PrivacyScreenPlusPlugin: FlutterPlugin, MethodCallHandler, ActivityAware,
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "privacy_screen_plus")
